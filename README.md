...
-   Every hour the R source code (at SVN) gets copied to github, into
    the repo <https://github.com/wch/r-source>.
...
-   Download the relevant `texinfo` manual files and associated images
